...
from src.data_augment import preproc
sys.path.append(os.getcwd() + '/../../src')

from src.data import FaceRectLMDataset, detection_collate
from src.multibox_loss import MultiBoxLoss
from src.prior_box import PriorBox
from tasks.task1.yufacedetectnet import YuFaceDetectNet
...
def train():
    ...
    txtpath="E:\\data\\facedata\\label.txt"
    # dataset_rect = FaceRectLMDataset(training_face_rect_dir,txtpath, img_dim, rgb_mean)
    dataset_landmark = FaceRectLMDataset(training_face_landmark_dir,txtpath,preproc(img_dim, rgb_mean) )
